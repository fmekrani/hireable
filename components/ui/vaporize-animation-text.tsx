      ...
      switch (animationState) {
        ...
        case "fadingIn": {
          ...
          if (fadeOpacityRef.current >= 1) {
            // If waitDuration is 0 or texts has only one item, go to done state
            if (animationDurations.WAIT_DURATION <= 0 || texts.length === 1) {
        ...
        case "done": {
          // Don't render anything - animation is complete
          break;
        }
      }
