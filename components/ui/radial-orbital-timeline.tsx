...
export default function RadialOrbitalTimeline({
  ...
  const calculateNodePosition = (index: number, total: number) => {
    ...
    const x = round(radius * Math.cos(radian) + centerOffset.x, 3);
    const y = round(radius * Math.sin(radian) + centerOffset.y, 3);
    ...
    const opacity = round(opacityValue, 6);
  ...
  return (
    <div
      className="w-full h-[720px] flex flex-col items-center justify-center bg-black overflow-hidden"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-white via-gray-200 to-zinc-400 animate-pulse flex items-center justify-center z-10">
